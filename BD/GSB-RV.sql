...
CREATE TABLE RapportVisite (
  ...
  rap_coef_confiance int DEFAULT NULL,
  mot_code varchar(6),
  PRIMARY KEY (vis_matricule,rap_num)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE Motif (
  mot_code varchar(6) NOT NULL DEFAULT '',
  mot_libelle varchar(50) DEFAULT NULL,
  mot_precision varchar(70) DEFAULT NULL,
  PRIMARY KEY (mot_code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO RapportVisite VALUES
	( 'a131' , 1 , '2018-03-01' , 'RAS' , 22, '2018-03-03', 5, 'F1' ) ,
	( 'a131' , 2 , '2018-04-02' , 'RAS' , 22, '2018-04-03', 4, 'F2' ) ,
	( 'a131' , 3 , '2018-04-03' , 'RAS' , 18, '2018-04-05', 4, 'F3' ) ,
	( 'a131' , 4 , '2018-05-10' , 'RAS' , 22, '2018-05-11', 3, 'F4' ) ,
	( 'a131' , 5 , '2018-05-21' , 'RAS' , 18, '2018-12-24', 1, 'F5' ) ;
	
INSERT INTO Motif VALUES
	( 'F1' , 'Visite périodique' , NULL) ,
	( 'F2' , 'Visite périodique' , NULL) ,
	( 'F3' , 'Visite périodique' , NULL) ,
	( 'F4' , 'Autre' , 'fortnite') ,
	( 'F5' , 'Autre' , 'foreskin') ;
...
ALTER TABLE RapportVisite ADD CONSTRAINT  FK_MOTIF FOREIGN KEY(mot_code) REFERENCES Motif(mot_code) ;
